...
from hf_hub_prompts import ChatPromptTemplate, TextPromptTemplate, download_prompt, list_prompts
...
def test_list_prompts():
    ...
    with patch("hf_hub_prompts.hub_api.HfApi") as mock_hf_api:
        ...
        mock_api_instance.list_repo_files.return_value = ["prompt1.yaml", "prompt2.yml", "not_a_prompt.txt"]
